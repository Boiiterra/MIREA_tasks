...
length = int(input("Введите размерность таблицы(2-16):"))
data = {}
LEN = -1
for i in range(0, 5):
    if (2**i == length):
...
print("]")
print("Введите значения для ячеек:")
if (first):
    for x in range(len(first) * 2):
        ...
        for y in range(len(second) * 2):
            if (y == 2):
                ...
                y = 2
            value = int(
                input("["+To2(x, len(first))+"]["+To2(y, len(second))+"]:"))
            data["["+To2(x, len(first))+"]["+To2(y, len(second))+"]"] = value
else:
    for y in range(len(second) * 2):
        value = int(input("["+To2(y, len(second))+"]:"))
        data["["+To2(y, len(second))+"]"] = value
print("-" * 20 + "\nВывод:")
# output
start_x = ""
if (first):
...
if (first):
    for x in range(len(first) * 2):
        if (x == 2):
            ...
            x = 2
        print(To2(x, len(first)), end=" " * (len(start_x) -
              len(first) - 1) + "|" + " " * len(start_y))
        for y in range(len(second) * 2):
            if (y == 2):
                y = 3
            elif (y == 3):
                y = 2
            print(data["["+To2(x, len(first))+"][" +
                  To2(y, len(second))+"]"], end=" " * (len(second)))
        print()
else:
...
positions = ["["+To2(0, len(first))+"]["+To2(0, len(second))+"]",
             "["+To2(len(first)*2 - delta_x, len(first)) +
             "]["+To2(0, len(second))+"]",
             "["+To2(0, len(first))+"]["+To2(len(second)
                                             * 2 - delta_y, len(second))+"]",
            ...
            if ((X < len(first) * 2) and (value == data["["+To2(X, len(first))+"]["+To2(0, len(second))+"]"]) and (value == data["["+To2(X, len(first))+"]["+To2(len(second)*2 - delta_y, len(second))+"]"])):
                if (value):
                    points.append(["["+To2(x, len(first))+"]["+To2(0, len(second))+"]",
                                   "["+To2(x, len(first))+"]["+To2(len(second)
                                                                   * 2 - delta_y, len(second))+"]",
                                   "["+To2(X, len(first))+"][" +
                                   To2(0, len(second))+"]",
